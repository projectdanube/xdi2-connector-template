...
<title>xdi2-connector-template</title>
<link rel="stylesheet" target="_blank" href="style.css" TYPE="text/css" MEDIA="screen">
</head>
<body style="background-image: url('images/back.png'); background-repeat: repeat-y; margin-left: 60px;">

	<div class="header">
	<img src="images/template-logo.png" align="middle">&nbsp;&nbsp;&nbsp;
	<img src="images/arrow.png" align="middle">&nbsp;&nbsp;&nbsp;
	<img src="images/logo64.png" align="middle">&nbsp;&nbsp;&nbsp;<span id="appname">xdi2-connector-template</span>
	</div>
	...
	<p>Certain parts of your graph will only be accessible if you have a Template API access token.</p>
